"""시도/시군구 목록 (응급의료기관 API STAGE1·STAGE2 파라미터용)."""

KOREA_REGIONS: dict[str, list[str]] = {
    "서울특별시": [
...
def iter_regions() -> list[tuple[str, str]]:
    return [
        (stage1, stage2)
        for stage1, districts in KOREA_REGIONS.items()
        for stage2 in districts
    ]
